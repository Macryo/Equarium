...
function validate(e) {
  ...
  var email = document.getElementById("email"); // let emailReg = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;

  var phone = document.getElementById("phone"); // let phoneReg = /(?<!\w)(\(?(\+|00)?48\)?)?[ -]?\d{3}[ -]?\d{3}[ -]?\d{3}(?!\w)/

  var msg = document.getElementById("msg");
  var FieldArray = [name, email, phone, msg];
  ...
  // }
      ...
      errorMsg.innerHTML = "Wiadomo\u015B\u0107 powinna zawiera\u0107 od 5 do 250 znak\xF3w";
    } else {
      document.getElementById("errorMsg").style.display = 'none';
...
aos__WEBPACK_IMPORTED_MODULE_6___default.a.init(); //scroll animation
...
document.querySelector('#dot1').addEventListener('click', function () {
  Object(_slider__WEBPACK_IMPORTED_MODULE_2__["currentSlide"])(1);
});
document.querySelector('#dot2').addEventListener('click', function () {
  Object(_slider__WEBPACK_IMPORTED_MODULE_2__["currentSlide"])(2);
});
...
document.getElementById('mc-embedded-subscribe-form').addEventListener('submit', _form__WEBPACK_IMPORTED_MODULE_1__["default"]); //contact form
// slider functionality//
...
module.exports = {
  more: more,
  MeetUsMobileBehavior: MeetUsMobileBehavior,
  MeetUsDesktopBehavior: MeetUsDesktopBehavior
};
